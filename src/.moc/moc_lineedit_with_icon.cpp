...
const QMetaObject LineEditWithIcon::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_LineEditWithIcon.data,
      qt_meta_data_LineEditWithIcon,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LineEditWithIcon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LineEditWithIcon.stringdata0))
        return static_cast<void*>(const_cast< LineEditWithIcon*>(this));
