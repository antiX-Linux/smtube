...
void FileChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FileChooser::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileChooser::fileChanged)) {
                *result = 0;
                return;
            }
        }
...
static const QMetaObject * const qt_meta_extradata_FileChooser[] = {
        &QFileDialog::staticMetaObject,
    Q_NULLPTR
};

const QMetaObject FileChooser::staticMetaObject = {
    { &LineEditWithIcon::staticMetaObject, qt_meta_stringdata_FileChooser.data,
      qt_meta_data_FileChooser,  qt_static_metacall, qt_meta_extradata_FileChooser, Q_NULLPTR}
};
